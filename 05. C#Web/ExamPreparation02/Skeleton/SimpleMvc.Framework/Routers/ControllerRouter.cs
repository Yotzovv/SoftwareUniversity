namespace SimpleMvc.Framework.Routers
{
    ...
    using SimpleMvc.Framework.Enums;
    using System;
    ...
    public class ControllerRouter : IHandleable
    {
        ...
        private void ProcessModelParameter(ParameterInfo parameter, int index)
        {
            ...
            {
                var postParameterValue = this.postParameters[modelProperty.Name].Replace(" ", string.Empty);

                object value;

                if (modelProperty.Name == "Position")
                {
                    value = (Positions)Enum.Parse(typeof(Positions), postParameterValue);
                }
                else
                {
