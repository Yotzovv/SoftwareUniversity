...
public class AbstractHero : IHero, IComparable<AbstractHero>
{
    ...
    public IInventory Inventory { get { return this.inventory; } }
    ...
    {
        (this.inventory as HeroInventory).AddRecipeItem(recipe as RecipeItem);
    }

    public void AddItem(IItem item)
    {
        this.inventory.AddCommonItem(item as CommonItem);
    }
    ...
    public override string ToString()
    {
       ...
       sb.Append((this.Items.Count == 0) ? "Items: None" : "Items:" + Environment.NewLine + string.Join(Environment.NewLine, Items));
