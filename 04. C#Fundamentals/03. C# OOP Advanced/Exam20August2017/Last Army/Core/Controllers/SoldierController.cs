...
public class SoldierController
{
 ...
 //  }
 //
 //  public static void TeamGetBonus(IArmy army, string rankerType)
 //  {
 ...
 //  }
 //
 //  public static void TeamGoesOnVacation(IArmy army, string rankerType)
 //  {
 //      foreach (var soldiers in army[rankerType])
 //      {
 //          soldiers.Regenerate();
 ...
 //  }
 //
 //  public static void TeamRegenerate(IArmy army, string rankerType)
 //  {
